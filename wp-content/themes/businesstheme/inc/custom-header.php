 ...
 *
 * @uses businesstheme_header_style()
 */
function businesstheme_custom_header_setup() {
...
add_action( 'after_setup_theme', 'businesstheme_custom_header_setup' );

if ( ! function_exists( 'businesstheme_header_style' ) ) :
/**
 * Styles the header image and text displayed on the blog
 *
 * @see businesstheme_custom_header_setup().
 */
